...
export OpenCV_DIR="${OpenCV_DIR:-/usr/lib/x86_64-linux-gnu/cmake/opencv4}"
export CUDNN_LIB_DIR="${CUDNN_LIB_DIR:-/home/sy/.local/lib/python3.8/site-packages/nvidia/cudnn/lib}"

_fastlio_prepend_path LD_LIBRARY_PATH "${ONNXRUNTIME_ROOT}/lib"
_fastlio_prepend_path LD_LIBRARY_PATH "/usr/local/cuda-12.2/lib64"
_fastlio_prepend_path LD_LIBRARY_PATH "/usr/local/lib"
_fastlio_prepend_path LD_LIBRARY_PATH "${CUDNN_LIB_DIR}"
...
export ROI_LIDAR_CORNER_ENABLE_D435I="${ROI_LIDAR_CORNER_ENABLE_D435I:-true}"
...
export ROI_LIDAR_CORNER_CORNER_RADIUS="${ROI_LIDAR_CORNER_CORNER_RADIUS:-5}"
...
export ROI_LIDAR_CORNER_DETECTOR_USE_GPU="${ROI_LIDAR_CORNER_DETECTOR_USE_GPU:-true}"
...
export ROI_LIDAR_CORNER_OPEN_DEBUG_WINDOW="${ROI_LIDAR_CORNER_OPEN_DEBUG_WINDOW:-false}"
export ROI_LIDAR_CORNER_ENABLE_RVIZ="${ROI_LIDAR_CORNER_ENABLE_RVIZ:-false}"
export ROI_LIDAR_CORNER_MIN_POINTS="${ROI_LIDAR_CORNER_MIN_POINTS:-2}"
export ROI_LIDAR_CORNER_MAX_TIME_DIFF_CLOUD="${ROI_LIDAR_CORNER_MAX_TIME_DIFF_CLOUD:-1.0}"
export ROI_LIDAR_CORNER_MAX_TIME_DIFF_ODOM="${ROI_LIDAR_CORNER_MAX_TIME_DIFF_ODOM:-0.5}"
...
export ROI_LIDAR_CORNER_HISTORY_WINDOW_SEC="${ROI_LIDAR_CORNER_HISTORY_WINDOW_SEC:-1.0}"
export ROI_LIDAR_CORNER_MAX_WINDOW_FRAMES="${ROI_LIDAR_CORNER_MAX_WINDOW_FRAMES:-30}"
...
export ROI_LIDAR_CORNER_CORNER_TARGET_POINTS="${ROI_LIDAR_CORNER_CORNER_TARGET_POINTS:-6}"
...
export ROI_LIDAR_CORNER_POST_MAX_Z_JUMP_M="${ROI_LIDAR_CORNER_POST_MAX_Z_JUMP_M:-0.8}"
